...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.user_agents_list = self._get_user_agents_list()
    ...
    def _get_user_agents_list(self):
        ...
        response = requests.get(self.scrapeops_endpoint, params=urlencode(payload))  # what is urlencode?
...
class ScrapeOpsFakeHeaderMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS')
        self.headers_list = self._get_headers_list()
